...
<h2>My popular topics <span class="pull-right"><a href="#">View all...</a></span></h2>    <p>Pellentesque habitant morbi
...
<h2>My popular presentations <span class="pull-right"><a href="#">View all...</a></span></h2>    <p>Pellentesque
                                                                                                    habitant morbi
                                                                                                    tristique senectus
                                                                                                    et netus et
                                                                                                    malesuada fames ac
...
<img src="/images/homer.gif" alt="{{Auth::user()->name}}" class="img-circle img-responsive" style="height: 325px"
     class="text-centered">
