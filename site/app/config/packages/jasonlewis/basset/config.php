...
return array(
	...
	*/
	...
	'collections' => array(
		'website_js' => function( $collection ) {
			
			$collection->add( 'assets/js/jquery.min.js' );
			$collection->add( 'assets/js/bootstrap.min.js' );

			$collection->requireTree( 'assets/js/libraries' );
			
			$collection->add( 'assets/js/gt.js' );
			$collection->add( 'assets/js/gt/events.js' );
			$collection->requireDirectory( 'assets/js/gt' )->except( 'assets/js/gt/events.js' );
			$collection->requireDirectory( 'assets/js/gt/events' );
			$collection->requireDirectory( 'assets/js/gt/form' );
			
		},
		'website_css' => function( $collection ) {
			$collection->add( 'assets/css/bootstrap.min.css' );
			$collection->requireTree( 'assets/css/libraries' );
			
			$collection->add( 'assets/css/global.css' );
